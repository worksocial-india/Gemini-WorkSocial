...
function PartPaymentCalculator() {
  ...
  return (
    ...
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Part Payment Calculator</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {result && (
          <div>
            ...
            <div className="mt-4">
              <h3 className="text-lg font-bold">New Amortization Schedule</h3>
              <AmortizationTable data={result.newAmortization} />
            </div>
          </div>
        )}
      </div>
